...
bayes_plot_hist(var_image, quantile = 0.75)
```
...
```{r, echo=TRUE, eval=TRUE}
# smoothness values correspond to labels 
labels <- c("Water", "ClearCut_Burn", "ClearCut_Soil",
            "ClearCut_Veg", "Forest", "Wetland")
...
bayes_plot_map(map_smooth_high, xmin = 751, xmax = 1500, ymin = 1, ymax = 750)
```
...
bayes_plot_map(map_smooth_low, xmin = 751, xmax = 1500, ymin = 1, ymax = 750)
```
