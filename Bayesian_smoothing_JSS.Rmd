...
```{r vcube, fig.width = 8, tidy="styler", fig.align = 'center', fig.cap = "Logit variance map showing values above the 3rd quartile for classes ClearCutSoil and Forest."}
...
```{r vcuben, fig.width = 8, tidy="styler", fig.align = 'center', fig.cap = "Logit variance map showing values above the 3rd quartile for classes ClearCutVeg and ClearCutBurn."}
bayes_plot_var(var_image, 
                 quantile = 0.75, 
                 palette = "Greens",
...
map_smooth_bayes <- bayes_smooth(probs_image,
    window_size = 7,
...
map_gaussian <- gaussian_smooth(probs_image, window_size = 7, sigma = 5 ) |> 
  bayes_label()
...
map_bilat <- bayes_label(bilat_smooth)
